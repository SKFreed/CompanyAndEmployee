...
namespace CompanyAndEmployee.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(CompanyAndEmployeeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Phone,Email,INN,Adress")] Companies companies)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Phone,Email,INN,Adress")] Companies companies)
        {
            if (id != companies.Id)
            {
                return NotFound();
